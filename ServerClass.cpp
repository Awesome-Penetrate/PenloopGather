...
bool ServerClass::_runDnsThread() {
    ...
    for (it = _dnsResult.begin(); it != _dnsResult.end(); it++) {
        ...
        /*
            ...
            callFunctionQuery.append(std::get<1>(DomainInfo)); // open ports
            callFunctionQuery.append("','");
            callFunctionQuery.append(std::get<2>(DomainInfo)); // response header
            callFunctionQuery.append("','");
            callFunctionQuery.append(std::get<3>(DomainInfo)); // http server title
            callFunctionQuery.append("','");
            callFunctionQuery.append(std::get<2>(*it));
            callFunctionQuery.append("','");
            callFunctionQuery.append("0");
            callFunctionQuery.append("','");
            callFunctionQuery.append(std::to_string(_jobID));
            callFunctionQuery.append("';");
...
std::tuple<std::string,std::string,std::string,std::string> ServerClass::_getDomainInfo(std::string host,std::string ip) {
    ...
    MyportScan * PortScan = new MyportScan;
